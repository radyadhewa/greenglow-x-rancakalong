							...
							<tbody>
								<tr>
									<td class="product-thumbnail">
										<img src="images/produk1.png" alt=" Image" class="img-fluid">
									</td>
									<td class="product-name">
										<h2 class="h5 text-black">Natural Soap with Olive Extract</h2>
									</td>
									<td>Rp50.000</td>
									<td>
								...
								<tr>
									<td class="product-thumbnail">
										<img src="images/produk3.png" alt="Image" class="img-fluid">
									</td>
									<td class="product-name">
										<h2 class="h5 text-black">Natural Soap with Goat Milk</h2>
									</td>
									<td>Rp55.000</td>
									<td>
										<div class="input-group mb-3 d-flex align-items-center quantity-container" style="max-width: 120px;">
						...
						<div class="col-md-7">
							...
							<div class="row mb-3">
								...
								<div class="col-md-6 text-right">
									<strong class="text-black">Rp105.000</strong>
								</div>
							</div>
							<div class="row mb-5">
								<div class="col-md-6">
