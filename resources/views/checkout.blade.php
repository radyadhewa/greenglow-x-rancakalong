  ...
  <meta name="keywords" content="bootstrap, bootstrap4" />
	...
	<body>
		...
		<nav class="custom-navbar navbar navbar navbar-expand-md navbar-dark bg-dark" arial-label="Furni navigation bar">
			...
			<div class="container">
				<a class="navbar-brand" href="index.html">GreenGlow<span>.</span></a>
		            ...
		            <div class="col-md-12">
		              ...
		              <div class="p-3 p-lg-5 border bg-white">
		                <table class="table site-block-order-table mb-5">
		                  ...
		                  <tbody>
		                    <tr>
		                      <td>Natural Soap with Olive Extract <strong class="mx-2">x</strong> 1</td>
		                      <td>Rp 50.000</td>
		                    </tr>
		                    <tr>
		                      <td>Natural Soap with Goat Milk <strong class="mx-2">x</strong>   1</td>
		                      <td>Rp. 55.000</td>
		                    </tr>
		                    <tr>
		                      <td class="text-black font-weight-bold"><strong>Cart Subtotal</strong></td>
		                      <td class="text-black">Rp. 105.000</td>
		                    </tr>
		                    <tr>
		                      <td class="text-black font-weight-bold"><strong>Order Total</strong></td>
		                      <td class="text-black font-weight-bold"><strong>Rp. 105.000</strong></td>
		                    </tr>
		                  </tbody>
		                </table>
					...
					<div class="row links-wrap">
						<div class="col-6 col-sm-6 col-md-3">
							<ul class="list-unstyled">
								...
								<li><a href="about.html">About GreenGlow</a></li>
							</ul>
						</div>
						...
						<div class="col-6 col-sm-6 col-md-3">
							<ul class="list-unstyled">
								...
								<li><a href="rancakalong.html">Our Partner</a></li>
							</ul>
						</div>
